...
namespace BusinessTasks.Great.Behaviors
{
    public class PostExecutionTasksBehavior : IPostExecutionTasksBehavior
    {
        public void PostExecutionTasks()
        {
            System.Console.WriteLine("GREAT CLIENT: Post Execution Tasks.");
        }
    }
}
