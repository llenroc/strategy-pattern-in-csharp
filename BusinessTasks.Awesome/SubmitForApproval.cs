...
using BusinessTasks.Awesome.Behaviors;
using BusinessTasks.Commons;
using System;
...
namespace BusinessTasks.Awesome
{
    public class SubmitForApproval : ManagerBase
    {
        public SubmitForApproval()
        {
            this.ValidateOrderBehavior = new ValidateOrderBehavior();
            this.SendEmailBehavior = new SendEmailBehavior();
            this.CreateReportBehavior = new CreateReportBehavior();
            this.PostExecutionTasksBehavior = new PostExecutionTasksBehavior();
        }
    }
}
